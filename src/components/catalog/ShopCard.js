...
import {addToTotalPrice} from "../../actions/totalPriceActions";
import {Container, Img, Button} from './shopCardStyle';

const ShopCard = ({ addToBasket, addToTotalPrice, item: { id, brand, name, price, type, img }}) => {
    ...
    return(
        <Container>
            ...
            <Button onClick={onClick} enable-background="new 0 0 511.343 511.343" viewBox="0 0 511.343 511.343" xmlns="http://www.w3.org/2000/svg">
